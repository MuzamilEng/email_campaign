...
function UpdateModal({ id }) {
  ...
  const [updateRecord, { isLoading, isError, error, isSuccess, success }] =
    ...
    <React.Fragment>
      ...
      <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
        ...
        <DialogContent dividers>
          <form
            className="flex justify-center items-center p-[2vw] w-full flex-col"
            onSubmit={onSubmit}
          >
            <p>Do you want to update this record? Please upload a new file here</p>
            <figure className=" mt-[2vw] cursor-pointer">
